...
[`myirc`](https://github.com/dsverdlo/minqlx-plugins#myessentials#myirc)|Supports broadcasting to keyed(passworded) channels, shows more colors, and broadcasts live updates to the topic.|[`raw`](https://raw.githubusercontent.com/dsverdlo/minqlx-plugins/master/myirc.py)
